...
void libraryMethod(){ //图书信息管理界面
	...
	do{
		...
		cout << "                               6 学生借阅" << endl;
		cout << "                               7 教师借阅" << endl;
		cout << "                               8 学生借阅信息列表显示" << endl;
		cout << "                               9 教师借阅信息列表显示" << endl;
		cout << "                               10 学生归还" << endl;
		cout << "                               11 教师归还" << endl;
		cout << "                               0 退出" << endl;
		cout << "----------------------------------------------------------------------" << endl;
...
void studentInterface(){ //学生界面
	...
	do{
		...
		cout << "                               3 图书列表显示" << endl;
		cout << "                               4 学生：图书借阅" << endl;
		cout << "                               5 学生：图书借阅列表显示" << endl;
		cout << "                               6 学生：图书归还" << endl;
		cout << "                               7 杂志查找" << endl;
		cout << "                               8 杂志列表显示" << endl;
		cout << "                               9 学生：杂志借阅" << endl;
		cout << "                               10 学生：杂志借阅列表显示" << endl;
...
void teacherInterface(){ //教师界面
	...
	do{
		...
		cout << "                               3 图书列表显示" << endl;
		cout << "                               4 教师：图书借阅" << endl;
		cout << "                               5 教师：图书借阅列表显示" << endl;
		cout << "                               6 教师：图书归还" << endl;
		cout << "                               7 杂志查找" << endl;
		cout << "                               8 杂志列表显示" << endl;
		cout << "                               9 教师：杂志借阅" << endl;
		cout << "                               10 教师：杂志借阅列表显示" << endl;
